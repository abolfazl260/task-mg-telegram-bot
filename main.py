...
async def post_init(app: Application):
    ...
    if app.job_queue:
        ...
        logging.warning("JobQueue not available — reminders and Jira sync disabled.")
...
def build_application(profile):
    ...
    if _feature(app, "tasks"):
        app.add_handler(CommandHandler("add", add_task)); app.add_handler(CommandHandler("tasks", list_tasks))
...
def main():
    init_csv(); init_teams(); init_habits(); init_users(); init_custom_bots()
