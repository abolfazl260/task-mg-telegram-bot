...
async def post_init(app:Application):
    ...
    if profile is not None:
        ...
        for cmd in commands:
            ...
            if cmd.command=="start" or (feature and profile.feature_enabled(feature)):
