...
def build_application(profile):
    ...
    # Rich create-task media must have a real MessageHandler. The generic usage
    # handler is not a task-input router and cannot reliably dispatch photos,
    # videos, documents, or locations to save_task.
