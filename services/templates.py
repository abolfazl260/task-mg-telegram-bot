...
def _a1_a2_intensive(lang_fa: str, lang_tag: str, resources: dict):
    ...
    steps = [
        # —— هفته ۰: آماده‌سازی ——
        {
            "title": f"تعیین سطح فعلی {lang_fa} (آزمون آنلاین A1)",
            "day_offset": 0,
            "priority": "high",
            "description": "یک آزمون تعیین سطح رایگان بزن و نمره را یادداشت کن.",
        },
        {
            "title": f"نصب ابزارها: {app} + Anki + دیکشنری",
            "day_offset": 0,
            "description": f"اپ {app}، Anki (فلش‌کارت) و یک دیکشنری خوب نصب شود.",
        },
        {
            "title": f"آشنایی با الفبا و تلفظ پایه {lang_fa}",
            "day_offset": 1,
            "description": "صداهای خاص زبان را با تکرار و گوش دادن تمرین کن.",
        },
        # —— هفته ۱: A1 پایه ——
        {
            "title": "یادگیری ۵۰ واژه ضروری روزمره (سلام، اعداد، رنگ‌ها)",
            "day_offset": 2,
            "description": "واژه‌ها را در Anki اضافه کن و هر روز مرور کن.",
        },
        {
            "title": "گرامر: ضمایر شخصی + فعل «بودن»",
            "day_offset": 3,
            "description": f"از منبع {course} بخش مربوطه را بخوان و ۱۰ جمله بساز.",
        },
        {
            "title": "مکالمه: معرفی خود (نام، سن، ملیت، شغل)",
            "day_offset": 4,
            "description": "متن معرفی را بنویس، بلند بخوان و ضبط کن.",
        },
        {
            "title": "۵۰ واژه جدید: خانواده، خانه، غذا",
            "day_offset": 5,
        },
        {
            "title": "گرامر: زمان حال ساده افعال پرکاربرد",
            "day_offset": 6,
        },
        {
            "title": "تمرین لیسنینگ ۵–۱۰ دقیقه (سطح A1)",
            "day_offset": 7,
            "description": f"از {podcast} یا {yt} محتوای سطح مبتدی گوش بده.",
        },
        # —— هفته ۲ ——
        {
            "title": "۵۰ واژه: خرید، لباس، قیمت‌ها",
            "day_offset": 9,
        },
        {
            "title": "گرامر: سوال ساختن (کجا، کی، چه، چرا)",
            "day_offset": 10,
        },
        {
            "title": "نقش‌آفرینی: خرید از فروشگاه",
            "day_offset": 11,
            "description": "دیالوگ کوتاه بنویس و با صدای بلند تمرین کن.",
        },
        {
            "title": "۵۰ واژه: جهت‌ها، شهر، وسایل نقلیه",
            "day_offset": 12,
        },
        {
            "title": "گرامر: حروف اضافه مکان و زمان",
            "day_offset": 13,
        },
        {
            "title": "نوشتن: توصیف محل زندگی (۸–۱۰ جمله)",
            "day_offset": 14,
            "priority": "high",
        },
        # —— هفته ۳ ——
        {
            "title": "۵۰ واژه: شغل، تحصیل، برنامه‌های روزانه",
            "day_offset": 16,
        },
        {
            "title": "گرامر: افعال کمکی و منفی کردن جمله",
            "day_offset": 17,
        },
        {
            "title": "لیسنینگ + تکرار سایه (shadowing) ۱۰ دقیقه",
            "day_offset": 18,
            "description": f"با {yt} یک ویدیوی کوتاه را جمله به جمله تکرار کن.",
        },
        {
            "title": "۵۰ واژه: آب‌وهوا، فصل‌ها، فعالیت‌های اوقات فراغت",
            "day_offset": 19,
        },
        {
            "title": "گرامر: زمان حال استمراری / ساختار در حال انجام",
            "day_offset": 20,
        },
        {
            "title": "آزمون میان‌دوره A1 + مرور نقاط ضعف",
            "day_offset": 21,
            "priority": "high",
        ...
        # —— هفته ۴: تثبیت A1 ——
        {
            "title": "مرور ۲۰۰ واژه اول با Anki (روزانه)",
            "day_offset": 23,
        },
        {
            "title": "مکالمه: یک روز معمولی خود را تعریف کن",
            "day_offset": 24,
            "description": "۲–۳ دقیقه صحبت ضبط‌شده؛ بدون نگاه به متن.",
        },
        {
            "title": "خواندن متن کوتاه A1 + خلاصه‌نویسی",
            "day_offset": 25,
            "description": f"از کتاب {book} یک متن کوتاه بخوان.",
        },
        {
            "title": "گرامر: صفت‌ها و ترتیب آن‌ها",
            "day_offset": 26,
        },
        {
            "title": "تمرین نوشتاری: ایمیل کوتاه دوستانه",
            "day_offset": 27,
        },
        {
            "title": "جمع‌بندی ماه اول + چک‌لیست مهارت‌های A1",
            "day_offset": 28,
            "priority": "high",
        ...
        # —— هفته ۵: ورود به A2 ——
        {
            "title": "۶۰ واژه سطح A2: سفر، هتل، رزرو",
            "day_offset": 30,
        },
        {
            "title": "گرامر: زمان گذشته ساده",
            "day_offset": 31,
            "description": "افعال بی‌قاعده پرکاربرد را جدا حفظ کن.",
        },
        {
            "title": "نقش‌آفرینی: رزرو هتل / خرید بلیت",
            "day_offset": 32,
        },
        {
            "title": "۶۰ واژه: احساسات، سلامتی، پزشک",
            "day_offset": 33,
        },
        {
            "title": "گرامر: گذشته استمراری / ساختارهای گذشته مکمل",
            "day_offset": 34,
        },
        {
            "title": "لیسنینگ ۱۵ دقیقه‌ای سطح A2",
            "day_offset": 35,
            "description": f"از {podcast} قسمت مناسب A2 گوش بده و ۵ واژه جدید یادداشت کن.",
        },
        # —— هفته ۶ ——
        {
            "title": "۶۰ واژه: کار، مصاحبه، محل کار",
            "day_offset": 37,
        },
        {
            "title": "گرامر: آینده (will / going to یا معادل)",
            "day_offset": 38,
        },
        {
            "title": "نوشتن: برنامه‌های آینده شغلی/تحصیلی (۱۲–۱۵ جمله)",
            "day_offset": 39,
            "priority": "high",
        },
        {
            "title": "۶۰ واژه: فناوری، اینترنت، شبکه‌های اجتماعی",
            "day_offset": 40,
        },
        {
            "title": "گرامر: جملات شرطی نوع صفر و یک",
            "day_offset": 41,
        },
        {
            "title": "مکالمه آزاد ۵ دقیقه‌ای درباره علایق",
            "day_offset": 42,
            "description": "بدون متن از قبل؛ فقط نکات کلیدی روی کاغذ.",
        },
        # —— هفته ۷ ——
        {
            "title": "۶۰ واژه: محیط زیست، شهر، مشکلات شهری",
            "day_offset": 44,
        },
        {
            "title": "گرامر: مجهول ساده (passive) در حد A2",
            "day_offset": 45,
        },
        {
            "title": f"خواندن داستان کوتاه ساده ({book})",
            "day_offset": 46,
            "description": "یک فصل/بخش کوتاه؛ واژه‌های جدید را در Anki بگذار.",
        },
        {
            "title": "تمرین درک مطلب + پاسخ به سوالات متن",
            "day_offset": 47,
        },
        {
            "title": "گرامر: نقل‌قول غیرمستقیم ساده",
            "day_offset": 48,
        },
        {
            "title": "آزمون آزمایشی A2 (نمونه سوال)",
            "day_offset": 49,
            "priority": "high",
            "description": "Listening + Reading + Writing کوتاه؛ نقاط ضعف را لیست کن.",
        },
        # —— هفته ۸: تثبیت و جمع‌بندی ——
        {
            "title": "مرور فشرده همه گرامرهای A1–A2",
            "day_offset": 51,
            "description": "یک صفحه خلاصه گرامر برای خودت بنویس.",
        },
        {
            "title": "مرور Anki: حداقل ۳۰۰ کارت فعال",
            "day_offset": 52,
        },
        {
            "title": "مکالمه ۱۰ دقیقه‌ای شبیه‌سازی مصاحبه/سفر",
            "day_offset": 53,
            "priority": "high",
        },
        {
            "title": "نوشتن نهایی: متن ۱۵۰ کلمه‌ای درباره تجربه یادگیری",
            "day_offset": 54,
        },
        {
            "title": "لیسنینگ نهایی بدون زیرنویس (۱۰–۱۵ دقیقه)",
            "day_offset": 55,
        },
        {
            "title": "آزمون تعیین سطح نهایی (هدف: A2)",
            "day_offset": 57,
            "priority": "high",
            "description": "همان نوع آزمون اول را تکرار کن و پیشرفت را مقایسه کن.",
        },
        {
            "title": "برنامه‌ریزی مسیر بعد از A2 (منابع B1)",
            "day_offset": 59,
...
def expand_template(template: dict, start: date | None = None):
    ...
    Returns list of {title, priority, deadline, category, tags, description}
    """
    if start is None:
        start = date.today()
