...
*{box-sizing:border-box}body{margin:0;font-family:Vazirmatn,Tahoma,system-ui,sans-serif;background:linear-gradient(135deg,#f8fafc,#eef2ff);color:#172033}main{max-width:1280px;margin:auto;padding:22px}.hero{background:linear-gradient(135deg,#0f172a,#263653);color:#fff;border-radius:28px;padding:28px;box-shadow:0 18px 50px #0f172a22}.hero h1{margin:0 0 8px;font-size:30px}.hero p{margin:0;color:#cbd5e1}.hero-top{display:flex;justify-content:space-between;align-items:center;gap:20px}.badge{background:#ffffff14;border:1px solid #ffffff20;border-radius:999px;padding:9px 13px;font-size:13px}.stats{display:grid;grid-template-columns:repeat(5,1fr);gap:12px;margin-top:18px}.stat{background:#ffffff0d;border:1px solid #ffffff14;border-radius:18px;padding:15px}.stat strong{display:block;font-size:25px}.stat span{font-size:12px;color:#cbd5e1}.card{background:#fff;border:1px solid #e8edf5;border-radius:22px;padding:20px;margin-top:16px;box-shadow:0 10px 30px #1720330a}.report-nav{display:flex;align-items:center;gap:8px;flex-wrap:wrap}.report-nav h2{margin:0 18px 0 0;font-size:18px;white-space:nowrap}.report-nav button{border:1px solid #e5eaf2;background:#f8fafc;color:#243044;border-radius:13px;padding:10px 14px;cursor:pointer;font:inherit;font-weight:600;transition:.18s}.report-nav button:hover{transform:translateY(-1px);background:#fff}.report-nav button.active{background:#172033;color:#fff;border-color:#172033}.summary-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:14px}.summary-box{background:#f8fafc;border-radius:17px;padding:15px}.summary-box h3{margin:0 0 10px;font-size:15px}.summary-row{display:flex;justify-content:space-between;padding:7px 0;border-bottom:1px solid #edf1f6;font-size:13px}.summary-row:last-child{border:0}.section-title{display:flex;justify-content:space-between;align-items:center;margin-bottom:14px}.section-title h2{margin:0;font-size:19px}.muted{color:#718096;font-size:13px}.table-wrap{overflow:auto;border:1px solid #e5eaf2;border-radius:18px}.table-wrap table{width:100%;border-collapse:separate;border-spacing:0;min-width:820px}.table-wrap th{background:#f8fafc;color:#667085;font-size:12px;font-weight:700;position:sticky;top:0}.table-wrap td,.table-wrap th{padding:13px 14px;text-align:right;border-bottom:1px solid #edf1f6}.table-wrap tbody tr:last-child td{border-bottom:0}.table-wrap tbody tr:hover{background:#f8faff}.row-number{width:55px;color:#98a2b3;font-weight:700;text-align:center!important}.task-title{font-weight:700;color:#172033}.priority{display:inline-flex;align-items:center;gap:6px;padding:5px 10px;border-radius:999px;font-size:12px;font-weight:700}.priority:before{content:"";width:7px;height:7px;border-radius:50%;background:currentColor}.priority-high{color:#b42318;background:#fff1f0}.priority-medium{color:#b54708;background:#fff7e8}.priority-low{color:#027a48;background:#ecfdf3}.status{display:inline-flex;padding:5px 10px;border-radius:999px;background:#f2f4f7;color:#475467;font-size:12px;font-weight:600}.board{display:grid;grid-template-columns:repeat(4,minmax(220px,1fr));gap:12px}.column{background:#f8fafc;border:1px solid #e8edf5;border-radius:18px;padding:12px;min-height:220px}.column h3{margin:3px 4px 12px;font-size:15px}.task{background:#fff;border:1px solid #edf0f5;border-radius:14px;padding:12px;margin:8px 0;box-shadow:0 3px 10px #00000008}.task b{display:block;margin-bottom:7px}.pager{display:flex;align-items:center;justify-content:center;gap:10px;margin-top:15px}.pager button{border:1px solid #e5eaf2;background:#fff;border-radius:10px;padding:8px 12px;cursor:pointer}.error{color:#b42318;background:#fff4f2;padding:12px;border-radius:12px}.loading{padding:22px;text-align:center;color:#718096}@media(max-width:900px){.stats{grid-template-columns:repeat(3,1fr)}.summary-grid{grid-template-columns:1fr}.board{grid-template-columns:1fr 1fr}}@media(max-width:650px){main{padding:12px}.hero{padding:20px;border-radius:22px}.hero-top{display:block}.badge{display:inline-block;margin-top:14px}.stats{grid-template-columns:repeat(2,1fr)}.report-nav{display:grid;grid-template-columns:repeat(2,1fr)}.report-nav h2{grid-column:1/-1;margin:0}.report-nav button{width:100%}.board{grid-template-columns:1fr}}
</style></head><body><main><section id="app" class="hero"><div class="loading">در حال بارگذاری گزارش...</div></section><section class="card"><div class="report-nav"><h2>گزارش‌های قابل مشاهده</h2><button data-section="tasks">📋 جدول وظایف</button><button data-section="kanban">🧩 کانبان</button><button data-section="calendar">📅 تقویم</button><button data-section="deadlines">⏰ مهلت‌ها</button><button data-section="status">📌 وضعیت‌ها</button><button data-section="priority">🚦 اولویت‌ها</button><button data-section="category">🗂 دسته‌بندی‌ها</button></div></section><section id="details" class="card"><div class="loading">برای مشاهده جزئیات یکی از گزارش‌ها را انتخاب کنید.</div></section></main><script>
...
function card(x){return `<div class="task"><b>${esc(x.title)}</b><span class="status">${esc(x.status_label)}</span> ${priority(x.priority)}</div>`}
